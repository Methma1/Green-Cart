            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                :(
                    <div className='relative group'>
                        ...
                        <ul className='hideen group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 py-2.5 w-30 rounded-md text-sm z-40'>
                            <li onClick={()=>navigate("my-orders")} className='p-1.5 pl-3 hover:bg-primary/10 cursor-pointer'>My oders</li>
